...
// general images
//hathi tari9 bach atzid tswira like imagesPath+"/forgot_password.jpg"; 
  static String forgotPassword = "$imagesPath/Forgot_password.gif"; 
  ...
  static String banner3 = "$bannersImagesPath/banner3.jfif";
  static String banner4 = "$bannersImagesPath/banner4.jfif";
  // Categories path
