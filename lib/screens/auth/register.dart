...
import 'package:project/widgets/auth/pick_image_widget.dart';
    ...
    if (isValid) {
      ...
      try {
        ...
        final ref = FirebaseStorage.instance
            .ref() // t3yet lel storage el
            .child("UsersImages") //t3mel access 3la dossier
            .child(
                '${_emailController.text.trim()}.jpg'); //bach tbdel 3la 7seb el tswira l7titha
